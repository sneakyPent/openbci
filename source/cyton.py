...
# SAMPLE_RATE = c.SAMPLE_RATE_250  # Hz
...
class OpenBCICyton(object):
    ...
    def _read_serial_binary(self, max_bytes_to_skip=3000):
        ...
        for rep in range(max_bytes_to_skip):
            ...
            # packetInBytes = read(cnts.RAW_PACKET_SIZE)
            # packet = struct.unpack('B', packetInBytes)
            # if not packet[cnts.RAW_PACKET_POSITION_START_BYTE] == cnts.RAW_BYTE_START:
    ...
    def get_channel_data_array(self, readPacket):
        ...
        for i in range(self.number_of_channels):
            ...
            dt = interpret_24_bit_as_int_32(currentChannel)
    ...
    def get_aux_data_array(self, readPacket):
        ...
        for i in range(self.aux_channels_per_sample):
            ...
            dt = interpret_16_bit_as_int_32(currentAux)
